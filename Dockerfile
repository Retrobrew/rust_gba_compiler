...
WORKDIR /data/gba
ENTRYPOINT bwrap --unshare-all --share-net --ro-bind / / --dev-bind /tmp /tmp --dev-bind /usr/local/cargo/registry/ /usr/local/cargo/registry/ --dev-bind /data /data ./make_example.sh rom
